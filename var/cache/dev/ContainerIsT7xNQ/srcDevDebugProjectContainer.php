...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            ...
            'App\\Controller\\FollowingController' => __DIR__.'/getFollowingControllerService.php',
            'App\\Controller\\LikesController' => __DIR__.'/getLikesControllerService.php',
            'App\\Controller\\MicroPostController' => __DIR__.'/getMicroPostControllerService.php',
            'App\\Controller\\NotificationController' => __DIR__.'/getNotificationControllerService.php',
            'App\\Controller\\RegisterController' => __DIR__.'/getRegisterControllerService.php',
            ...
            'app.greeting' => __DIR__.'/getApp_GreetingService.php',
            ...
            'console.command.public_alias.App\\Command\\HelloCommand' => __DIR__.'/getHelloCommandService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('d5wPuvX0Kq', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gp0TBhMnA4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('security.interactive_login', array(0 => function () {
            return ($this->privates['App\Event\UserLocaleSubscriber'] ?? $this->load(__DIR__.'/getUserLocaleSubscriberService.php'));
        }, 1 => 'onInteractiveLogin'), 15);
        $instance->addListener('user.register', array(0 => function () {
            return ($this->privates['App\Event\UserSubscriber'] ?? $this->load(__DIR__.'/getUserSubscriberService.php'));
        }, 1 => 'onUserRegister'), 0);
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r8gCuLL-Pq', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RZrZidUAEx', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iJPpitObP8', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 4 => ($this->privates['App\Security\MicroPostVoter'] ?? $this->load(__DIR__.'/getMicroPostVoterService.php'));
