...
$a->setNamespace('sf_orm_default_966075b75612b653a012bfe5ba74932548697d5f36f0fac66c65564838fab225');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_966075b75612b653a012bfe5ba74932548697d5f36f0fac66c65564838fab225');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_966075b75612b653a012bfe5ba74932548697d5f36f0fac66c65564838fab225');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\LikeNotificationRepository' => function () {
    return ($this->privates['App\Repository\LikeNotificationRepository'] ?? $this->load(__DIR__.'/getLikeNotificationRepositoryService.php'));
}, 'App\\Repository\\MicroPostRepository' => function () {
    return ($this->privates['App\Repository\MicroPostRepository'] ?? $this->load(__DIR__.'/getMicroPostRepositoryService.php'));
}, 'App\\Repository\\NotificationRepository' => function () {
    return ($this->privates['App\Repository\NotificationRepository'] ?? $this->load(__DIR__.'/getNotificationRepositoryService.php'));
}, 'App\\Repository\\UserPreferencesRepository' => function () {
    return ($this->privates['App\Repository\UserPreferencesRepository'] ?? $this->load(__DIR__.'/getUserPreferencesRepositoryService.php'));
